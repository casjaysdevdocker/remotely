...
# Docker image for remotely using the alpine template
ARG IMAGE_NAME="remotely"
ARG PHP_SERVER="remotely"
...
ARG IMAGE_REPO="casjaysdevdocker/remotely"
...
ARG PACK_LIST="remotely nginx ${PHP_VERSION:-system}-fpm"
...
ENV HOSTNAME="casjaysdevdocker-remotely"
...
LABEL org.opencontainers.image.url="https://hub.docker.com/r/casjaysdevdocker/remotely"
LABEL org.opencontainers.image.url.source="https://hub.docker.com/r/casjaysdevdocker/remotely"
LABEL org.opencontainers.image.vcs-type="Git"
LABEL org.opencontainers.image.vcs-ref="${BUILD_VERSION}"
LABEL org.opencontainers.image.vcs-url="https://github.com/casjaysdevdocker/remotely"
LABEL org.opencontainers.image.documentation="https://github.com/casjaysdevdocker/remotely"
